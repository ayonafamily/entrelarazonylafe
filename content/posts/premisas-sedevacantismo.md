---
title: "Premisas equivocadas en el razonamiento sedevacantista"
date: 2026-03-07T17:43:50-05:00
author: "Jorge Luis Ayona Inglis"
ShowReadingTime: true
draft: false

# Descripción larga del artículo (SEO / metadata)
description: "Un análisis crítico sobre las premisas lógicas y eclesiológicas del sedevacantismo. Desde el testimonio personal en la FSSPX hasta la refutación de la invisibilidad de la Iglesia y el error de confundir infalibilidad con impecabilidad."

# Resumen usado en listados y previews (PaperMod)
summary: "A partir de una experiencia de seis años en la FSSPX, este artículo desglosa los errores teológicos del sedevacantismo, analizando por qué la negación de la autoridad papal contradice la indefectibilidad de la Iglesia y la tradición católica."
...
Para muchos católicos estos cambios fueron recibidos con normalidad.
Pero en ciertos sectores generaron una profunda inquietud.
...
Su posición era distinta:
afirmaba que el concilio había introducido errores o ambigüedades, pero que el Papa seguía siendo Papa.
